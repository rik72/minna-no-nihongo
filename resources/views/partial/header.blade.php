...
<html lang="en">
  <head>
    ...
    <meta name="description" content="japanese phrases generator">
    <meta name="keywords" content="japanese generator">
    <meta name="author" content="Riccardo Mazzei">
    <link rel="icon" href="assets/images/favicon/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="assets/images/favicon/favicon.png" type="image/x-icon">
    <title>みゲン - Japanese phrases generator</title>
    <!-- Google font-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="/"><img class="img-fluid for-light" src="assets/images/logo/logo.png" alt=""><img class="img-fluid for-dark" src="assets/images/logo/logo-dark.png" alt=""></a></div>
          ...
          */?>
          ...
          <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">real name</div>
            </div>
            </div>
          </script>
      ...
      <div class="page-body-wrapper horizontal-menu">
        ...
        <div class="sidebar-wrapper">
          <div>
            <div class="logo-wrapper"><a href="/" class="h1 text-white">みゲン</a>
              <div class="back-btn"><i class="fa fa-angle-left"></i></div>
              <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="align-left"> </i></div>
            </div>
            <div class="logo-icon-wrapper"><a href="/" class="h1 text-white">み</a></div>
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list my-1"><a class="sidebar-link sidebar-title" href="/"><i data-feather="home"></i><span>Home</span></a></li>
                  <li class="sidebar-list my-1"><a class="sidebar-link sidebar-title" href="/generator"><i data-feather="zap"></i><span>Generator</span></a></li>
                </ul>
              </div>
